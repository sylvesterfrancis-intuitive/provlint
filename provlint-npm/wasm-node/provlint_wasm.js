/* @ts-self-types="./provlint_wasm.d.ts" */

class WasmProvLint {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WasmProvLintFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmprovlint_free(ptr, 0);
    }
    /**
    ...
    detectFormat(content) {
        ...
        const ret = wasm.wasmprovlint_detectFormat(this.__wbg_ptr, ptr0, len0);
        let v2;
        if (ret[0] !== 0) {
     ...
     */
    getSupportedRules() {
        const ret = wasm.wasmprovlint_getSupportedRules(this.__wbg_ptr);
        return ret;
    }
    /**
    ...
    lint(content, format) {
        ...
        const ret = wasm.wasmprovlint_lint(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return ret;
    }
    /**
     ...
     * @returns {any}
     */
    lintWithConfig(content, format, config) {
        const ptr0 = passStringToWasm0(content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(format, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmprovlint_lintWithConfig(this.__wbg_ptr, ptr0, len0, ptr1, len1, config);
        return ret;
    }
    constructor() {
        const ret = wasm.wasmprovlint_new();
        this.__wbg_ptr = ret >>> 0;
        WasmProvLintFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) WasmProvLint.prototype[Symbol.dispose] = WasmProvLint.prototype.free;
exports.WasmProvLint = WasmProvLint;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./provlint_wasm_bg.js": import0,
    };
}

const WasmProvLintFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmprovlint_free(ptr >>> 0, 1));
...
const wasmPath = `${__dirname}/provlint_wasm_bg.wasm`;
